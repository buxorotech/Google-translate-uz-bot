...
def start(updater,context):
 updater.message.reply_text('🖑Salom, Men Tarjimon botman! Botdan foydalanish uchun @foydali_link_1 kanaliga a'zo bo'lib, qayta /start ni bosib ishga tushiring! ')
